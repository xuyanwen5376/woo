...
class ChatBarWidgetState extends State<ChatBarWidget> {
  ...
  Widget _buildBar() {
    ...
    ws.add(
      ...
      ).paddingRight(AppSpace.iconTextSmail).onTap(_onToggleVoice),
    );
    ...
    if (_isShowVoice != true) {
      ws.add(
        ...
        ).height(38).paddingRight(AppSpace.iconTextSmail).expanded(),
      );
    }
    ...
    ws.add(
      IconWidget.svg(
        ...
        size: 32,
        color: AppColors.outline,
      ).paddingRight(AppSpace.iconTextSmail).onTap(_onToggleEmoji),
    );
